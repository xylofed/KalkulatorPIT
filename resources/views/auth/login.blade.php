...
<style>
    ...
    .navbar {
        ...
        left: 0;
        z-index: 1050;
        background-color: #262b52; /* dopasuj do reszty jeśli trzeba */
        box-shadow: 0 2px 8px rgba(37, 117, 252, 0.7);
        padding: 0.5rem 1rem;
    }
...
.login-container {
    ...
    .card {
        ...
        width: 100%;
        max-width: 600px; /* szersze niż kalkulator demo */
        color: #e0e7ff;
        padding: 30px 40px;
    }
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email"
                        ...
                        value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Wpisz swój email">
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password"
                        ...
                        required autocomplete="current-password" placeholder="Wpisz hasło">
